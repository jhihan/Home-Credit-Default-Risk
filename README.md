...
<img src="https://render.githubusercontent.com/render/math?math=\sigma=\sqrt{\frac{p(1-p)}{N}}"> in order to get the confidence interval (95% confidence level means the interval $[p-2\sigma,p+2\sigma]$).
